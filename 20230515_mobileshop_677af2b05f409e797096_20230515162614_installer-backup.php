...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230515_mobileshop_677af2b05f409e797096_20230515162614_archive.zip';
        const ARCHIVE_SIZE       = '168723275';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '677af2b-15162614';
        const SECONDARY_PACKAGE_HASH = 'f13b57b-15162614';
        const VERSION            = '1.5.4';
